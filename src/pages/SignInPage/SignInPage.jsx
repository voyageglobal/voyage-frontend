      ...
      <section className="min-h-96 pt-36">
        <div className="container mx-auto">
          <div className="flex gap-20">
            <div className="flex w-1/2 flex-col justify-center font-fourth text-lg text-dark-color">
              ...
              <div className="mt-4 space-y-4">
                <div className="relative">
                  ...
                  />
                  <AtSign className="absolute right-3 top-1/2 -translate-y-1/2 transform text-light-color" />
                </div>
                <div className="relative">
                  <input
                    type="password"
                    ...
                    className={inputStyles}
                  />
                  <LockKeyhole className="absolute right-3 top-1/2 -translate-y-1/2 transform text-light-color" />
                </div>
              </div>
              ...
              <p className="mt-6 text-center text-dark-color/80">
                ...
                <Link to="#" className={`${linkStyles} ml-2 hover:underline`}>
                  Sign up here
                </Link>
              </p>
            </div>
            ...
            <div
              className="h-[40rem] w-[51rem] rounded-xl bg-cover bg-center"
